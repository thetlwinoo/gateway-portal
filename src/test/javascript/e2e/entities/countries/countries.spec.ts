...
describe('Countries e2e test', () => {
    ...
    it('should load Countries', async () => {
        ...
        expect(await countriesComponentsPage.getTitle()).to.eq('portalApp.countries.home.title');
    });
    ...
    it('should load create Countries page', async () => {
        ...
        expect(await countriesUpdatePage.getPageTitle()).to.eq('portalApp.countries.home.createOrEditLabel');
    ...
    it('should delete last Countries', async () => {
        ...
        expect(await countriesDeleteDialog.getDialogTitle()).to.eq('portalApp.countries.delete.question');
