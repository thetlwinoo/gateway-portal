...
describe('People e2e test', () => {
    ...
    it('should load People', async () => {
        ...
        expect(await peopleComponentsPage.getTitle()).to.eq('portalApp.people.home.title');
    });
    ...
    it('should load create People page', async () => {
        ...
        expect(await peopleUpdatePage.getPageTitle()).to.eq('portalApp.people.home.createOrEditLabel');
    ...
    it('should create and save People', async () => {
        ...
        expect(await peopleUpdatePage.getHashedPasswordInput()).to.eq('hashedPassword');
        ...
        expect(await peopleUpdatePage.getFaxNumberInput()).to.eq('faxNumber');
    ...
    it('should delete last People', async () => {
        ...
        expect(await peopleDeleteDialog.getDialogTitle()).to.eq('portalApp.people.delete.question');
