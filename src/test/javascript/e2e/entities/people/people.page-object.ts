...
export class PeopleUpdatePage {
    ...
    hashedPasswordInput = element(by.id('field_hashedPassword'));
    ...
    async setHashedPasswordInput(hashedPassword) {
        await this.hashedPasswordInput.sendKeys(hashedPassword);
    }

    async getHashedPasswordInput() {
        return this.hashedPasswordInput.getAttribute('value');
    }
