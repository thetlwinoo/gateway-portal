...
describe('CustomerTransactions e2e test', () => {
    ...
    it('should load CustomerTransactions', async () => {
        ...
        expect(await customerTransactionsComponentsPage.getTitle()).to.eq('portalApp.customerTransactions.home.title');
    });
    ...
    it('should load create CustomerTransactions page', async () => {
        ...
        expect(await customerTransactionsUpdatePage.getPageTitle()).to.eq('portalApp.customerTransactions.home.createOrEditLabel');
    ...
    it('should delete last CustomerTransactions', async () => {
        ...
        expect(await customerTransactionsDeleteDialog.getDialogTitle()).to.eq('portalApp.customerTransactions.delete.question');
