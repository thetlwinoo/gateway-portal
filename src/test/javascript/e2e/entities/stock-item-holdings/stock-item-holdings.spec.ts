...
describe('StockItemHoldings e2e test', () => {
    ...
    it('should load StockItemHoldings', async () => {
        ...
        expect(await stockItemHoldingsComponentsPage.getTitle()).to.eq('portalApp.stockItemHoldings.home.title');
    });
    ...
    it('should load create StockItemHoldings page', async () => {
        ...
        expect(await stockItemHoldingsUpdatePage.getPageTitle()).to.eq('portalApp.stockItemHoldings.home.createOrEditLabel');
    ...
    it('should delete last StockItemHoldings', async () => {
        ...
        expect(await stockItemHoldingsDeleteDialog.getDialogTitle()).to.eq('portalApp.stockItemHoldings.delete.question');
