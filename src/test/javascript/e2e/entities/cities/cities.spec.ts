...
describe('Cities e2e test', () => {
    ...
    it('should load Cities', async () => {
        ...
        expect(await citiesComponentsPage.getTitle()).to.eq('portalApp.cities.home.title');
    });
    ...
    it('should load create Cities page', async () => {
        ...
        expect(await citiesUpdatePage.getPageTitle()).to.eq('portalApp.cities.home.createOrEditLabel');
    ...
    it('should delete last Cities', async () => {
        ...
        expect(await citiesDeleteDialog.getDialogTitle()).to.eq('portalApp.cities.delete.question');
