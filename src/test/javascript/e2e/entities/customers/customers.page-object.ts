...
export class CustomersUpdatePage {
    ...
    accountOpenedDateInput = element(by.id('field_accountOpenedDate'));
    standardDiscountPercentageInput = element(by.id('field_standardDiscountPercentage'));
    isStatementSentInput = element(by.id('field_isStatementSent'));
    isOnCreditHoldInput = element(by.id('field_isOnCreditHold'));
    ...
    async getCreditLimitInput() {
        return this.creditLimitInput.getAttribute('value');
    }

    async setAccountOpenedDateInput(accountOpenedDate) {
        await this.accountOpenedDateInput.sendKeys(accountOpenedDate);
    }

    async getAccountOpenedDateInput() {
        return this.accountOpenedDateInput.getAttribute('value');
    }

    async setStandardDiscountPercentageInput(standardDiscountPercentage) {
        await this.standardDiscountPercentageInput.sendKeys(standardDiscountPercentage);
    }

    async getStandardDiscountPercentageInput() {
        return this.standardDiscountPercentageInput.getAttribute('value');
    }

    getIsStatementSentInput() {
        return this.isStatementSentInput;
    }
    getIsOnCreditHoldInput() {
        return this.isOnCreditHoldInput;
    }
