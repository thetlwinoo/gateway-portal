...
describe('StockGroups e2e test', () => {
    ...
    it('should load StockGroups', async () => {
        ...
        expect(await stockGroupsComponentsPage.getTitle()).to.eq('portalApp.stockGroups.home.title');
    });
    ...
    it('should load create StockGroups page', async () => {
        ...
        expect(await stockGroupsUpdatePage.getPageTitle()).to.eq('portalApp.stockGroups.home.createOrEditLabel');
    ...
    it('should delete last StockGroups', async () => {
        ...
        expect(await stockGroupsDeleteDialog.getDialogTitle()).to.eq('portalApp.stockGroups.delete.question');
