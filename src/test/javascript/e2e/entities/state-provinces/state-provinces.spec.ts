...
describe('StateProvinces e2e test', () => {
    ...
    it('should load StateProvinces', async () => {
        ...
        expect(await stateProvincesComponentsPage.getTitle()).to.eq('portalApp.stateProvinces.home.title');
    });
    ...
    it('should load create StateProvinces page', async () => {
        ...
        expect(await stateProvincesUpdatePage.getPageTitle()).to.eq('portalApp.stateProvinces.home.createOrEditLabel');
    ...
    it('should delete last StateProvinces', async () => {
        ...
        expect(await stateProvincesDeleteDialog.getDialogTitle()).to.eq('portalApp.stateProvinces.delete.question');
