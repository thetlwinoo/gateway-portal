...
describe('PurchaseOrderLines e2e test', () => {
    ...
    it('should load PurchaseOrderLines', async () => {
        ...
        expect(await purchaseOrderLinesComponentsPage.getTitle()).to.eq('portalApp.purchaseOrderLines.home.title');
    });
    ...
    it('should load create PurchaseOrderLines page', async () => {
        ...
        expect(await purchaseOrderLinesUpdatePage.getPageTitle()).to.eq('portalApp.purchaseOrderLines.home.createOrEditLabel');
    ...
    it('should create and save PurchaseOrderLines', async () => {
        ...
        expect(await purchaseOrderLinesUpdatePage.getOrderedOutersInput()).to.eq('5');
    ...
    it('should delete last PurchaseOrderLines', async () => {
        ...
        expect(await purchaseOrderLinesDeleteDialog.getDialogTitle()).to.eq('portalApp.purchaseOrderLines.delete.question');
