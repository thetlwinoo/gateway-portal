...
describe('CustomerCategories e2e test', () => {
    ...
    it('should load CustomerCategories', async () => {
        ...
        expect(await customerCategoriesComponentsPage.getTitle()).to.eq('portalApp.customerCategories.home.title');
    });
    ...
    it('should load create CustomerCategories page', async () => {
        ...
        expect(await customerCategoriesUpdatePage.getPageTitle()).to.eq('portalApp.customerCategories.home.createOrEditLabel');
    ...
    it('should delete last CustomerCategories', async () => {
        ...
        expect(await customerCategoriesDeleteDialog.getDialogTitle()).to.eq('portalApp.customerCategories.delete.question');
