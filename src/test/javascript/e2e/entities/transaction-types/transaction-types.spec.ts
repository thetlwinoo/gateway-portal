...
describe('TransactionTypes e2e test', () => {
    ...
    it('should load TransactionTypes', async () => {
        ...
        expect(await transactionTypesComponentsPage.getTitle()).to.eq('portalApp.transactionTypes.home.title');
    });
    ...
    it('should load create TransactionTypes page', async () => {
        ...
        expect(await transactionTypesUpdatePage.getPageTitle()).to.eq('portalApp.transactionTypes.home.createOrEditLabel');
    ...
    it('should delete last TransactionTypes', async () => {
        ...
        expect(await transactionTypesDeleteDialog.getDialogTitle()).to.eq('portalApp.transactionTypes.delete.question');
