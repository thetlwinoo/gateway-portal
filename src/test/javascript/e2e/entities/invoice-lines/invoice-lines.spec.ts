...
describe('InvoiceLines e2e test', () => {
    ...
    it('should load InvoiceLines', async () => {
        ...
        expect(await invoiceLinesComponentsPage.getTitle()).to.eq('portalApp.invoiceLines.home.title');
    });
    ...
    it('should load create InvoiceLines page', async () => {
        ...
        expect(await invoiceLinesUpdatePage.getPageTitle()).to.eq('portalApp.invoiceLines.home.createOrEditLabel');
    ...
    it('should delete last InvoiceLines', async () => {
        ...
        expect(await invoiceLinesDeleteDialog.getDialogTitle()).to.eq('portalApp.invoiceLines.delete.question');
