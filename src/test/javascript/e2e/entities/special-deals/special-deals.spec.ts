...
describe('SpecialDeals e2e test', () => {
    ...
    it('should load SpecialDeals', async () => {
        ...
        expect(await specialDealsComponentsPage.getTitle()).to.eq('portalApp.specialDeals.home.title');
    });
    ...
    it('should load create SpecialDeals page', async () => {
        ...
        expect(await specialDealsUpdatePage.getPageTitle()).to.eq('portalApp.specialDeals.home.createOrEditLabel');
    ...
    it('should delete last SpecialDeals', async () => {
        ...
        expect(await specialDealsDeleteDialog.getDialogTitle()).to.eq('portalApp.specialDeals.delete.question');
