...
describe('VehicleTemperatures e2e test', () => {
    ...
    it('should load VehicleTemperatures', async () => {
        ...
        expect(await vehicleTemperaturesComponentsPage.getTitle()).to.eq('portalApp.vehicleTemperatures.home.title');
    });
    ...
    it('should load create VehicleTemperatures page', async () => {
        ...
        expect(await vehicleTemperaturesUpdatePage.getPageTitle()).to.eq('portalApp.vehicleTemperatures.home.createOrEditLabel');
    ...
    it('should delete last VehicleTemperatures', async () => {
        ...
        expect(await vehicleTemperaturesDeleteDialog.getDialogTitle()).to.eq('portalApp.vehicleTemperatures.delete.question');
