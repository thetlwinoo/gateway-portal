...
describe('ProductSubCategory e2e test', () => {
    ...
    it('should load ProductSubCategories', async () => {
        ...
        expect(await productSubCategoryComponentsPage.getTitle()).to.eq('portalApp.productSubCategory.home.title');
    });
    ...
    it('should load create ProductSubCategory page', async () => {
        ...
        expect(await productSubCategoryUpdatePage.getPageTitle()).to.eq('portalApp.productSubCategory.home.createOrEditLabel');
    ...
    it('should delete last ProductSubCategory', async () => {
        ...
        expect(await productSubCategoryDeleteDialog.getDialogTitle()).to.eq('portalApp.productSubCategory.delete.question');
