...
describe('Invoices e2e test', () => {
    ...
    it('should load Invoices', async () => {
        ...
        expect(await invoicesComponentsPage.getTitle()).to.eq('portalApp.invoices.home.title');
    });
    ...
    it('should load create Invoices page', async () => {
        ...
        expect(await invoicesUpdatePage.getPageTitle()).to.eq('portalApp.invoices.home.createOrEditLabel');
    ...
    it('should delete last Invoices', async () => {
        ...
        expect(await invoicesDeleteDialog.getDialogTitle()).to.eq('portalApp.invoices.delete.question');
