...
describe('ProductCategory e2e test', () => {
    ...
    it('should load ProductCategories', async () => {
        ...
        expect(await productCategoryComponentsPage.getTitle()).to.eq('portalApp.productCategory.home.title');
    });
    ...
    it('should load create ProductCategory page', async () => {
        ...
        expect(await productCategoryUpdatePage.getPageTitle()).to.eq('portalApp.productCategory.home.createOrEditLabel');
    ...
    it('should create and save ProductCategories', async () => {
        ...
        await productCategoryComponentsPage.clickOnCreateButton();
        await promise.all([productCategoryUpdatePage.setProductCategoryNameInput('productCategoryName')]);
    ...
    it('should delete last ProductCategory', async () => {
        ...
        expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('portalApp.productCategory.delete.question');
