...
describe('StockItemTransactions e2e test', () => {
    ...
    it('should load StockItemTransactions', async () => {
        ...
        expect(await stockItemTransactionsComponentsPage.getTitle()).to.eq('portalApp.stockItemTransactions.home.title');
    });
    ...
    it('should load create StockItemTransactions page', async () => {
        ...
        expect(await stockItemTransactionsUpdatePage.getPageTitle()).to.eq('portalApp.stockItemTransactions.home.createOrEditLabel');
    ...
    it('should delete last StockItemTransactions', async () => {
        ...
        expect(await stockItemTransactionsDeleteDialog.getDialogTitle()).to.eq('portalApp.stockItemTransactions.delete.question');
