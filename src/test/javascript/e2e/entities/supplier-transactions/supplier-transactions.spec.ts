...
describe('SupplierTransactions e2e test', () => {
    ...
    it('should load SupplierTransactions', async () => {
        ...
        expect(await supplierTransactionsComponentsPage.getTitle()).to.eq('portalApp.supplierTransactions.home.title');
    });
    ...
    it('should load create SupplierTransactions page', async () => {
        ...
        expect(await supplierTransactionsUpdatePage.getPageTitle()).to.eq('portalApp.supplierTransactions.home.createOrEditLabel');
    ...
    it('should delete last SupplierTransactions', async () => {
        ...
        expect(await supplierTransactionsDeleteDialog.getDialogTitle()).to.eq('portalApp.supplierTransactions.delete.question');
