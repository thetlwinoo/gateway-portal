...
describe('StockItemStockGroups e2e test', () => {
    ...
    it('should load StockItemStockGroups', async () => {
        ...
        expect(await stockItemStockGroupsComponentsPage.getTitle()).to.eq('portalApp.stockItemStockGroups.home.title');
    });
    ...
    it('should load create StockItemStockGroups page', async () => {
        ...
        expect(await stockItemStockGroupsUpdatePage.getPageTitle()).to.eq('portalApp.stockItemStockGroups.home.createOrEditLabel');
    ...
    it('should create and save StockItemStockGroups', async () => {
        ...
        await promise.all([
            ...
            stockItemStockGroupsUpdatePage.stockItemSelectLastOption()
        ]);
    ...
    it('should delete last StockItemStockGroups', async () => {
        ...
        expect(await stockItemStockGroupsDeleteDialog.getDialogTitle()).to.eq('portalApp.stockItemStockGroups.delete.question');
