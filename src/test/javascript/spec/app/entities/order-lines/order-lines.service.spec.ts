...
describe('Service Tests', () => {
    describe('OrderLines Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new OrderLines(0, 'AAAAAAA', 0, 0, 0, 0, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a OrderLines', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        pickingCompletedWhen: currentDate.format(DATE_TIME_FORMAT)
            ...
            it('should update a OrderLines', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        quantity: 1,
            ...
            it('should return a list of OrderLines', async () => {
                const returnedFromService = Object.assign(
                    {
                        description: 'BBBBBB',
                        quantity: 1,
            ...
            it('should delete a OrderLines', async () => {
