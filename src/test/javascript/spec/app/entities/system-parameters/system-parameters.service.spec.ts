...
describe('Service Tests', () => {
    describe('SystemParameters Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new SystemParameters(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SystemParameters', async () => {
                ...
                service
                    .create(new SystemParameters(null))
                    .pipe(take(1))
            ...
            it('should update a SystemParameters', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of SystemParameters', async () => {
                const returnedFromService = Object.assign(
                    {
                        deliveryAddressLine1: 'BBBBBB',
                        deliveryAddressLine2: 'BBBBBB',
            ...
            it('should delete a SystemParameters', async () => {
