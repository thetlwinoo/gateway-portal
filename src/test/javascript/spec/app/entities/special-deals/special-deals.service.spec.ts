...
describe('Service Tests', () => {
    describe('SpecialDeals Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new SpecialDeals(0, 'AAAAAAA', currentDate, currentDate, 0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a SpecialDeals', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        startDate: currentDate.format(DATE_FORMAT),
            ...
            it('should update a SpecialDeals', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of SpecialDeals', async () => {
                const returnedFromService = Object.assign(
                    {
                        dealDescription: 'BBBBBB',
                        startDate: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a SpecialDeals', async () => {
