...
describe('Service Tests', () => {
    describe('PurchaseOrders Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new PurchaseOrders(0, currentDate, currentDate, 'AAAAAAA', 0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PurchaseOrders', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        orderDate: currentDate.format(DATE_FORMAT),
            ...
            it('should update a PurchaseOrders', async () => {
                const returnedFromService = Object.assign(
                    {
                        orderDate: currentDate.format(DATE_FORMAT),
                        expectedDeliveryDate: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a PurchaseOrders', async () => {
